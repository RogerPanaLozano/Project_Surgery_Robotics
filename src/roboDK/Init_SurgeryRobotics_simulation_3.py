...
def main():
    ...
    # Torque in tkinter
    torque_label = tk.Label(root, text="Torque Values: N/A", font=("Arial", 12))
...
# Determine torque level color
    ...
    robot_thread = threading.Thread(target=move_robot, args=(robot, gripper, needle, text_label,torque_label, torque_button))
